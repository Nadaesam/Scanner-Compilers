...
D:\FCAI 4\Compilers
    InFile f("D:\\FCAI 4\\Compilers\\Ass2_compiler\\input.txt");
    int line = 0;
    ...
    while (f.GetNewLine()) {
        ...
        for (int i = 0; i < l.length(); i++) {
            ...
            if (l[i] == '{') {
                ...
                cout <<"(" <<TokenTypeStr[17] << ")   [" << line << "] " << endl;
            } else if (l[i] == '}') {
                commentstate = false;
                cout <<"(" <<TokenTypeStr[18] << ")   [" << line << "] " << endl;
            }
            if (!commentstate) {
                if (l[i] == '^') {
                    cout <<"(" <<TokenTypeStr[15] << ")   [" << line << "] " << endl;
                } else if (l[i] == '/') {
                    cout <<"(" <<TokenTypeStr[14] << ")   [" << line << "] " << endl;

                } else if (l[i] == '+') {
                    cout <<"(" <<TokenTypeStr[11] << ")   [" << line << "] " << endl;

                } else if (l[i] == '-') {
                    cout <<"(" <<TokenTypeStr[12] << ")   [" << line << "] " << endl;

                } else if (l[i] == '*') {
                    cout <<"(" <<TokenTypeStr[13] << ")   [" << line << "] " << endl;
                }

                if (l[i] == '<') {
                    cout <<"(" <<TokenTypeStr[4] << ")   [" << line << "] " << endl;
                ...
                if (!IsLetter(l[i]) && lexeme.length() > 0) {
                    string type = " ID";
                ...
                if (!IsDigit(l[i]) && num.length() > 0) {
                    cout << " ( "<<TokenTypeStr[22] << ")  " << num << " [" << line << "] " << endl;
                    num = "";
                } else if (IsDigit(l[i])) {
                    // Identifier
                    num += l[i];
